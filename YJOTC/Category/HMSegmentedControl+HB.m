...
- (void)_configureStyle {
    ...
    self.selectionIndicatorColor = kColorFromStr(@"#896FED");
    
    NSDictionary *attributesNormal = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"PingFangSC-Regular" size:18],NSFontAttributeName, [UIColor colorWithHexString:@"#999999"], NSForegroundColorAttributeName,nil];
    NSDictionary *attributesSelected = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"PingFangSC-Semibold" size:18],NSFontAttributeName, kColorFromStr(@"#896FED"), NSForegroundColorAttributeName,nil];
