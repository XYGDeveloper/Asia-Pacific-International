...
- (void)viewDidLoad {
    ...
    self.title = kLocat(@"k_MybounsViewController_title");
    ...
    self.header.countDes.text = kLocat(@"k_MybounsViewController_top_label_1");
    ...
    self.api  = [[GetBountsApi alloc]initWithKey:kUserInfo.token lanage:[Utilities gadgeLanguage:@""] token_id:[NSString stringWithFormat:@"%ld",kUserInfo.uid] uuid:[Utilities randomUUID] startTime:@"" endTime:@""];
    ...
    self.header.queryAction = ^{
        ...
        sself.api  = [[GetBountsApi alloc]initWithKey:kUserInfo.token lanage:[Utilities gadgeLanguage:@""] token_id:[NSString stringWithFormat:@"%ld",kUserInfo.uid] uuid:[Utilities randomUUID] startTime:sself.startimeStr endTime:sself.endTimeStr];
