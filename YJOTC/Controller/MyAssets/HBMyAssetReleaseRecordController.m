//
//  HBMyAssetReleaseRecordController.m
//  HuaBi
//
...
@interface HBMyAssetReleaseRecordController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HBMyAssetReleaseRecordController
...
- (void)viewDidLoad {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"HBMyAssetReleaseRecordCell" bundle:nil] forCellReuseIdentifier:@"HBMyAssetReleaseRecordCell"];
...
-(void)loadDataWith:(NSInteger)page
{
    ...
    [kNetwork_Tool POST_HTTPS:[Utilities handleAPIWith:@"/AccountManage/freed_list"] andParam:param completeBlock:^(BOOL success, NSDictionary *responseObj, NSError *error) {
...
{
    static NSString *rid = @"HBMyAssetReleaseRecordCell";
    HBMyAssetReleaseRecordCell *cell = [tableView dequeueReusableCellWithIdentifier:rid];
    if (cell == nil) {
