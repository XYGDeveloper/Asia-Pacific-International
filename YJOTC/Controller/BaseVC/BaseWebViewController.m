...
-(void)setupWebView
{
    ...
    UIView *statusView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenW, kStatusBarHeight)];
...
//
    if ([Utilities isExpired]) {
        cookieValue =  [NSString stringWithFormat:@"document.cookie = 'odrtoken=%@';document.cookie = 'odrplatform=ios';document.cookie = 'odruuid=%@';document.cookie = 'odrthink_language=%@';",@"1",[Utilities randomUUID],[Utilities gadgeLanguage:@""]];
    }else{
        cookieValue =  [NSString stringWithFormat:@"document.cookie = 'odrtoken=%@';document.cookie = 'odrplatform=ios';document.cookie = 'odruuid=%@';document.cookie = 'odrthink_language=%@';",kUserInfo.token, [Utilities randomUUID],[Utilities gadgeLanguage:@""]];
    }
//    cookieValue= @"";
...
-(void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    ...
    kLOG(@"%@===",webView.URL.absoluteString);
...
//        }
        ...
        if ([Utilities isExpired]) {
            JSFuncString = [NSString stringWithFormat:@"document.cookie = 'odrtoken=%@';document.cookie = 'odrplatform=ios';document.cookie = 'odruuid=%@';document.cookie = 'odrthink_language=%@';",@"1",[Utilities randomUUID],[Utilities gadgeLanguage:@""]];
        }else{
            JSFuncString = [NSString stringWithFormat:@"document.cookie = 'odrtoken=%@';document.cookie = 'odrplatform=ios';document.cookie = 'odruuid=%@';document.cookie = 'odrthink_language=%@';",kUserInfo.token,[Utilities randomUUID],[Utilities gadgeLanguage:@""]];
        }
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message
{
    ...
    if ([actionSting isEqual:@"iosLoginAction"]) {
        ...
        [kUserDefaults setObject:CHINESESimlple forKey:@"kUser_Language_Key"];
