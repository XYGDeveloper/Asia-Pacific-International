...
@property (nonatomic,copy)NSString *D_change7;
...
@property (nonatomic,copy)NSString *done_money_24;
@property (nonatomic,copy)NSString *H_done_num;
...
@interface YTData_listModel : NSObject
@property (nonatomic,copy)NSString *name;
@property (nonatomic,copy)NSString *id;
@property (nonatomic,copy)NSArray *data_list;
@end
